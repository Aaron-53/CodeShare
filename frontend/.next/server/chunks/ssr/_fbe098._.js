                ...
                children: [
                    {
                        name: "index.js",
                        type: "file",
                        content: "// Get all posts"
                    },
                    {
                        name: "[id].js",
                        type: "file",
                        content: "// Get post by ID"
                    }
                ]
            }
        ]
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$sample$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/components/sample.tsx [app-ssr] (ecmascript)");
...
;
function CodeEditor() {
    const [files] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$sample$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["INITIAL_FILES"]);
    ...
    const findFileContent = (node, targetName)=>{
        if (node.type === "file" && node.name === targetName) {
            return node.content || "";
        }
        if (node.children) {
            for (const child of node.children){
                const content = findFileContent(child, targetName);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (selectedFile) {
            const content = findFileContent(files, selectedFile);
            if (content) {
    ...
    const selectFile = (fileName)=>{
        ...
        const path = findFilePath(files, fileName);
        if (path) {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("pre", {
                                    ...
                                    dangerouslySetInnerHTML: {
                                        __html: findFileContent(files, selectedFile)
                                    }
                                }, void 0, false, {
                                    fileName: "[project]/app/page.tsx",
                                    lineNumber: 232,
...
//# sourceMappingURL=_fbe098._.js.map